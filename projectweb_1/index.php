            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Body Mask Index Form</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Menghitung Body Mass Index (BMI)</h2>
            ...
            <div class="card-body">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title text-light">Input Form</h3>
                    </div>
                    ...
                    <form method="post" action="index.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="bb" id="bb" required class="form-control" placeholder="Masukkan Berat Badan">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="tb" id="tb" required class="form-control" placeholder="Masukkan Tinggi Badan">
                                </div>
                            </div>
            ...
            $pasien_hardcode = ['kodePasien' => 'FX-PAS-001', 'tanggal' => '20-04-2022', 'nama' => 'Ronaldo', 'jk' => 'Laki-laki', 'bb' => 70.7, 'tb' => 188, 'bmi' => 15.4, 'status' => 'Kekurangan Berat Badan', 'image' => 'kurus'];
