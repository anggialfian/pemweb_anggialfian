...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="index.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">WebAdmin</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= base_url('assets/back-end/template/') ?>dist/img/anggi.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">Anggi Alfian</a>
            </div>
        </div>
