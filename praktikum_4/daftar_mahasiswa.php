        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    $mhs1 = new Mahasiswa("0001", "Bambang", 2020, "Teknik Informatika", 1.3);
                    $mhs2 = new Mahasiswa("0002", "Apri", 2019, "Teknik Informatika", 2.7);
                    $mhs3 = new Mahasiswa("0003", "Anggi", 2021, "Sistem Informasi", 3.8);
                    $mhs4 = new Mahasiswa("0004", "Asnur", 2019, "Sistem Informasi", 3.0);
                ?>
                    <thead>
                        <tr>
