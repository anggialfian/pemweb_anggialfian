<div class="container">
    <img src="<?= base_url('assets/back-end/template/') ?>dist/img/anggi.jpg" alt="Developer Photo's" class="shadow-lg">
    <h2 class="text-center display-5">Welcome, <?= $this->session->userdata('name') ?></h2>
